...
class MQTTClientBuilder(BuilderBase):
    ...
    def build(self, **kwargs) -> None:
        ...
        def on_connect(
            ...
            See https://eclipse.dev/paho/files/paho.mqtt.python/html/client.html#paho.mqtt.client.Client.on_message:~:text=property-,on_connect,-%3A%20Callable%5B
        ...
        def on_message(
            ...
            See https://eclipse.dev/paho/files/paho.mqtt.python/html/client.html#paho.mqtt.client.Client.on_message:~:text=property-,on_message,-%3A%20Callable%5B
